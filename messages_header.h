...
#define ID_HIGH         0x80
enum ECUReceivIdLow{SYSTEM_STATE_ID = 0xA1} ;
...
static UART_Receive headers_R[3][8] = {
    {headers_R[ECU][SYSTEM_STATE].id[0] = SYSTEM_STATE_ID,headers_R[ECU][SYSTEM_STATE].id[0] = ID_HIGH, headers_R[ECU][SYSTEM_STATE].length = 1},
...
static UART_Send headers_S[3][8] = {
    {headers_S[ECU][PARAM].id = 0xA0, headers_S[ECU][PARAM].length = 1},
